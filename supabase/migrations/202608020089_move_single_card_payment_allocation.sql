...
begin
  ...
  -- An explicit full-value choice corrects one prior association. Multiple
  -- allocations remain protected because they may represent a real split.
  if existing_count=1
    and existing_allocation.statement_id<>target.id
    and p_allocated_amount is null then
