...
begin
  ...
  -- An exact full-value choice replaces stale legacy associations atomically.
  -- A partial value cannot erase an existing split allocation.
  if existing_count>0
    and abs(requested_amount-abs(payment.amount))<=0.01
